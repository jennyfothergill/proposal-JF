...
original: users of the software not the problem
while we recognise the proposed work is <aspirational challenging>, we are positioned for success based on our prior work developing proofs of concept and molecular simulation on gpus
...
what makes a good NFA?

- Plan well-reasoned, well organized, based on sound rationale?


- Mechanism to assess success?
%%<comparing mobilities, diffraction to experiment>
...
- Mechanism to assess success?
a sign of well-written, understandable code is if other people use it. 
It's tricky because this is completely out of my control, but if other people find my code useful--it is a success.
by integrating what I do with other existing codebases I can help to achieve this goal.
Also having good tutorials and documentation.
...
experience with teaching/training undergrads
